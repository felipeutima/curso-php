...
if (isset($_GET['pos']) && $_GET['pos'] >= 0) //para obtener la posicion dentro de la tabla
{
    ...
    #para actualizar la imagen sino recuperar la del cliente
    if ($_FILES['archivo']['error'] !== UPLOAD_ERR_OK) {
...
if (isset($_GET['eliminar']) && $_GET['eliminar'] >= 0) //para obtener la posicion dentro de la tabla
{
    ...
    $nombreImagen=$aClientes[$pos]["imagen"];#para seleccionar la imagen dentro del array
                        ...
                        <?php foreach ($aClientes as $pos => $cliente) : ?>
                            ...
                            <tr>
                                <?php if ($cliente['imagen'] == '') : ?>
                                    ...
                                    <td><img src="imagenes/blanco.jpg" class="img-thumbnail" alt=""></td>
