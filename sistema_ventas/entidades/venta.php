...
class Venta
{
    ...
    public function cargarFormulario($request)
    {
        ...
        if(isset($request["lstAnio"]) && isset($request["lstMes"]) && isset($request["lstDia"]) && isset($request["txtHora"])){
    ...
    public function obtenerFacturacionPorPeriodo($fechaDesde, $fechaActual){
        $mysqli = new mysqli(Config::BBDD_HOST, Config::BBDD_USUARIO, Config::BBDD_CLAVE, Config::BBDD_NOMBRE, Config::BBDD_PORT);
        $sql = "SELECT SUM(total) AS sumatotal
                FROM ventas 
                WHERE fecha >='$fechaDesde' AND fecha <= '$fechaActual'";
